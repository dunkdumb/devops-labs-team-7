...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.service-card, .portfolio-item, .process-step, .team-profile');
...
// Creative elements animation enhancement
document.addEventListener('DOMContentLoaded', () => {
    const creativeElements = document.querySelectorAll('.design-icon, .marketing-icon, .content-icon');
